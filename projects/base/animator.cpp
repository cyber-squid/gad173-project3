...
void Animator::Load(sf::Texture *tileSheet, int spriteWidth, int spriteHeight)
{
...
void Animator::SetSpriteCycle(sf::Vector2i startFrames, sf::Vector2i endFrames, int speed)
{
